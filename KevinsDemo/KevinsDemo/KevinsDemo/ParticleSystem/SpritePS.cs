...
namespace DPSF.ParticleSystems
{
	...
	class SpriteParticleSystem : DPSFDefaultSpriteParticleSystem<SpriteParticle, DefaultSpriteParticleVertex>
	{
		...
		public void InitializeParticleAttraction(DPSFParticle Particle)
		{
            ...
            float rand = DPSFHelper.RandomNumberBetween(0f, 1f);

            if (rand > 0.5f)
                //Toroid; Outside Radius = 300f, Inside Radius = 300f-50f = 250f
                cParticle.Position = (DPSFHelper.RandomPointOnCircleVector3() * new Vector3(300f, 300f, 0f) + DPSFHelper.RandomPointOnCircleVector3() * new Vector3(50f, 50f, 0f));
            else
                //Filled Circle; Radius = 300f
                //cParticle.Position = (DPSFHelper.RandomPointOnCircleVector3() + DPSFHelper.RandomPointOnCircleVector3()) * new Vector3(300f, 300f, 0f);

                //Circle; Radius = 300f
                cParticle.Position = DPSFHelper.RandomPointOnCircleVector3() * new Vector3(300f, 300f, 0f);
            float color = RandomNumber.Between(0.05f, 0.24f);
            cParticle.Color = HelperFunctions.HSL2RGB(color, RandomNumber.NextFloat(), RandomNumber.NextFloat() / 5f + 0.3f);
