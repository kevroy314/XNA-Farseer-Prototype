...
{
    class KevinsDemo1 : PhysicsGameScreen, IDemoScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            _agentTexture = ScreenManager.Content.Load<Texture2D>("Samples/chrono");
            ...
            blur = new VariableBlurEffect.VariableBlurEffect(ScreenManager.Content, ScreenManager.GraphicsDevice, ScreenManager.GraphicsDevice.Viewport.Bounds, 30, 30, 6);
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ScreenManager.SpriteBatch.Draw(_polygonTexture, ConvertUnits.ToDisplayUnits(_compound.Position),
                                           ...
                                           0f);
            ScreenManager.SpriteBatch.Draw(_agentTexture, ConvertUnits.ToDisplayUnits(_agentBody.Position),
