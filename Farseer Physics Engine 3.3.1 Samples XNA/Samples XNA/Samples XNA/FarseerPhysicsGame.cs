...
namespace FarseerPhysics.SamplesFramework
{
    ...
    public class FarseerPhysicsGame : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            KevinsDemo1 kevinsdemo1 = new KevinsDemo1();

            GameDemo1 game1 = new GameDemo1();

            MenuScreen menuScreen = new MenuScreen("Farseer Samples");

            menuScreen.AddMenuItem("Kevin's Samples", EntryType.Separator, null);
            menuScreen.AddMenuItem(kevinsdemo1.GetTitle(), EntryType.Screen, kevinsdemo1);
